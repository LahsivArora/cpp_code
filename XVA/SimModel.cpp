...
std::vector<RateCurve> SimulateRate::getSimulatedCurves(){
    ...
    RateCurve sim01("USD.SOFR",{{0.5,0.0233},{1.0,0.0383},{2.0,0.0508},{5.0,0.0498},{7.0,0.0483},{10.0,0.0458}});
    RateCurve sim02("USD.SOFR",{{0.5,0.0218},{1.0,0.0368},{2.0,0.0493},{5.0,0.0483},{7.0,0.0468},{10.0,0.0443}});
    RateCurve sim03("USD.SOFR",{{0.5,0.0240},{1.0,0.0390},{2.0,0.0513},{5.0,0.0500},{7.0,0.0483},{10.0,0.0458}});
    RateCurve sim04("USD.SOFR",{{0.5,0.0210},{1.0,0.0360},{2.0,0.0488},{5.0,0.0480},{7.0,0.0468},{10.0,0.0443}});
    RateCurve sim05("USD.SOFR",{{0.5,0.0240},{1.0,0.0385},{2.0,0.0505},{5.0,0.0480},{7.0,0.0460},{10.0,0.0430}});
